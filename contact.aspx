			    ...
			    <div class="col-md-8 contact_left">
					...
					<form>
					    <div class="form_details">
						    ...
						    <input type="text" class="text" value="概述" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '概述';}">
						    <textarea value="Message" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message';}">描述</textarea>
...
<script type="text/javascript">
    ...
    function createMap() {
        ...
        var point = new BMap.Point(112.950336, 28.185609);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{ title: "我们", content: "我的备注", point: "112.950318|28.185657", isOpen: 0, icon: { w: 21, h: 21, l: 0, t: 0, x: 6, lb: 5 } }
    ];
    //创建marker
    function addMarker() {
