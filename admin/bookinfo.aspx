<%@ Page Title="" Language="C#" MasterPageFile="~/base1.Master" AutoEventWireup="true" CodeBehind="bookinfo.aspx.cs" Inherits="WebApplication4.admin.bookinfo" %>
    ...
    <div class="pages">
	    <div class="container">
            ...
            <div class="col-xs-5 col-sm-5">
                ...
                剩余*：<asp:TextBox ID="bookres" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ControlToValidate="bookres" ID="RequiredFieldValidator10" runat="server" ErrorMessage="不能为空" ForeColor="Red"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="必须为两位小数数字" ControlToValidate="booktotal" ValidationExpression="(\d+)"></asp:RegularExpressionValidator><br /><br />
                ...
                照片： <asp:Image ID="Image1" runat="server" /><asp:FileUpload ID="FileUpload1" runat="server" Wrap="False" />
